...
export default function OnboardingEmpresaPage() {
  ...
  async function handleCreateCompany(e: React.FormEvent) {
    ...
    try {
      ...
      // Force silent session refresh so isCompany flag is immediately available (avoids race in middleware)
    ...
    <div className="mx-auto max-w-2xl px-4 py-10">
      ...
      {step === 2 && (
        <section className="grid gap-3 rounded-lg border p-4">
          ...
          <button className="rounded-md bg-[var(--color-primary)] px-4 py-2 text-sm font-semibold text-white">Conectar Meta</button>
